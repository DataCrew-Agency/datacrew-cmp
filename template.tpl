...
injectScript('https://raw.githubusercontent.com/DataCrew-Agency/datacrew-cmp/main/dist/consent-bar.min.js', data.gtmOnSuccess, data.gtmOnFailure, 'dataCrewCMP');
      ...
      "param": [
        {
          ...
          "value": {
            ...
            "listItem": [
              {
                "type": 1,
                "string": "https://raw.githubusercontent.com/DataCrew-Agency/datacrew-cmp/main/*"
              }
            ]
          }
        }
