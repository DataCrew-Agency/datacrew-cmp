...
var S={v:"i",l:gl(),ac:0,mc:0,rv:0,be:null,oe:null,wr:null};
...
function inj(){
var ex=document.getElementById("dcs");
if(ex)ex.remove();
...
// Title
".dct{background:"+C.cs+";color:#fff;text-align:center;font-size:18px;padding:12px;margin:0;font-weight:700;flex-shrink:0;border-radius:16px 16px 0 0}"+
...
".dctx a{color:"+C.pc+";text-decoration:underline}"+
// Buttons
...
".dcpb{background:"+C.cs+";color:#fff}"+
...
// Create fixed wrapper attached to body
var wr=document.createElement("div");
wr.className="dcw";

// Overlay inside wrapper
var o=document.createElement("div");
o.className="dco"+(C.so?"":" dch");
o.onclick=function(){if(S.rv)hb();};
wr.appendChild(o);

// Banner - append directly to body with inline styles for mobile
var mobile=isMobile();
var posClass=mobile?"dcp-bottom":"dcp-"+C.bp;
var b=document.createElement("div");
b.className="dcb "+posClass+(S.v==="c"?" dccv":"");
if(mobile){b.style.cssText="position:fixed;bottom:0;left:0;right:0;top:auto;transform:none;width:100%;max-width:100%;z-index:99999;";}
...
var pc=C.pb||"dcpb",sc2=C.sb||"dcsb";
...
cts.className="dccts";
cts.appendChild(cct("n",t("n"),t("nd"),1,1));
cts.appendChild(cct("a",t("a"),t("ad"),S.ac,0));
cts.appendChild(cct("m",t("m"),t("md"),S.mc,0));
sc.appendChild(cts);
b.appendChild(sc);
var bt=document.createElement("div");
bt.className="dcbt";
...
ft.className="dcf";
ft.innerHTML='<a href="https://github.com/DataCrew-Agency/datacrew-cmp" target="_blank">Free CMP by DataCrew</a>';
b.appendChild(ft);

if(mobile){document.body.appendChild(b);}else{wr.appendChild(b);}
...
function hb(){S.v="i";if(S.be){S.be.remove();}if(S.wr){S.wr.remove();S.wr=null;S.be=null;S.oe=null;}}
window[C.go]={
